...
\begin{lemma} \textcolor{red}{plus $h$?}
	\begin{align*}
	\Gamma^*_{\hat{\distv}}(\sqrt{n}\hat{\boldsymbol{\psi}})	\xrightarrow{d}\Gamma^*_{\distv}(\rvv) \text{ and } F^{-1}_{\Gamma^*_{\hat{\distv}}(\hat{\distv})}(\alpha) \rightarrow  F^{-1}_{\Gamma^*_{\distv}(\rvv) }(\alpha)
	\end{align*}
\end{lemma}
\textcolor{blue}{
