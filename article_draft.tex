...
\usepackage{amsmath,amsthm,amsfonts,dsfont,mathtools,float,setspace, booktabs, algorithm,tcolorbox,xparse,colortbl,longtable,array,multirow,wrapfig,float,pdflscape,tabu, setspace, threeparttable,threeparttablex,makecell,natbib, pdfpages, url}
...
This initial screening step has become increasingly important as the research collect information on more and more potentially related observations. 
